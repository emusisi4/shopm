...
<div>
      <div class="card" v-if="allowedtoaccesscomponent > 0 ">
              <div class="card-header">
                <h3 class="card-title"><b>SUB MENU - DETAILS  </b></h3>
...
$('#addNew').modal('show');
  ...
  confirmButtonText: 'Yes, delete it!'
    ...
    if(result.value){
            ...
            loadDatarecords(){
              axios.get("api/submenuscomponentaccess").then(({ data }) => (this.allowedtoaccesscomponent = data));
   axios.get("api/submenus").then(({ data }) => (this.mydataObject = data));
   //getting the mainmenu 
