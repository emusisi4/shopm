              ...
              <div class="card-header p-0 pt-1 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                  ...
                  <a class="nav-link active" id="custom-tabs-three-home-tab" data-toggle="pill" href="#custom-tabs-three-home" role="tab"  @click="loadDatarecords()"
                   aria-controls="custom-tabs-three-home" aria-selected="true">Main Menus</a>
                  </li>
                  <li class="nav-item" v-if="allowedtoaccesscategoriescomponent > 0 ">
                    <a class="nav-link" id="custom-tabs-three-profile-tab" data-toggle="pill" href="#custom-tabs-three-profile" role="tab"
                     @click="loadDatarecordsSubmenus()" aria-controls="custom-tabs-three-profile" aria-selected="false">SUB MENUS</a>
                  </li> 
            
                  <li class="nav-item" v-if="allowedtoaccessproductunitscomponent > 0 ">
       <a class="nav-link" id="custom-tabs-three-messages-tab" data-toggle="pill" href="#custom-tabs-three-messages" role="tab"  @click="loadDatarecordsVuecomponents()" aria-controls="custom-tabs-three-messages" aria-selected="false">VUE-COMPONENTS</a>
                  </li>
                  <li class="nav-item" v-if="allowedtoaccessbrandscomponent > 0 ">
                    <a class="nav-link" id="custom-tabs-three-settings-tab" data-toggle="pill" href="#custom-tabs-three-settings" role="tab" @click="loadDatarecordsforformfeatures()" aria-controls="custom-tabs-three-settings" aria-selected="false">FORM / COMPONENT FEATURES</a>
                  </li>
                </ul>
              </div>
              <div class="card-body">
                <div class="tab-content" id="custom-tabs-three-tabContent">
                  <div class="tab-pane fade active show" id="custom-tabs-three-home" role="tabpanel" aria-labelledby="custom-tabs-three-home-tab">
                     ...
                     SYSTEM MAIN MENUS <button v-if="info > 0" type="button" class="add-newm" @click="newModal" >Add New </button>
                     </div>
...
<form @submit.prevent="editmode ? updateRecord():createNewrecord()">
        ...
        class="form-control form-control-sm" :class="{ 'is-invalid': form.errors.has('mainmenuname') }">
      <has-error :form="form" field="mainmenuname"></has-error>
        ...
        class="form-control form-control-sm" :class="{ 'is-invalid': form.errors.has('iconclass') }">
...
axios.get("api/mainmenucomponents").then(({ data }) => (this.mydataObject = data));
